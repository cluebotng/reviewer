...
from cbng_reviewer.models import CurrentRevision, Edit, PreviousRevision, TrainingData
...
class ApiEditTestCase(TestCase):
    ...
    def testWithCreationTrainingData(self):
        edit = Edit.objects.create(id=1234, status=2, classification=1)
        ...
        CurrentRevision.objects.create(
            edit=edit, timestamp=1753826150, is_minor=False, is_creation=True, text=b"Current Text"
        )
