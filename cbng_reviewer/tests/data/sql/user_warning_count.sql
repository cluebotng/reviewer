-- Minimal data used in testGetUserWarningCount
...
INSERT INTO page (
    ...
    23253223, 3, CAST('Example_User' as binary), 0, 0, 0.777155401146, 20240801095616,
...
(1, 0, '', ''),
(2, 0, CAST('General note: Nonconstructive editing' as binary), ''),
(3, 0, '', ''),
(4, 0, CAST('Warning Example User - #1' as binary), ''),
(5, 0, '', ''),
(6, 0, '', ''),
(7, 0, CAST('General note: Nonconstructive editing' as binary), '');
